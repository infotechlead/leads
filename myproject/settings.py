...
ALLOWED_HOSTS = ['leads-5w34.onrender.com', 'localhost', '127.0.0.1',"leads.neoinfotech.in"]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'neoinfotech.dev@gmail.com'
EMAIL_HOST_PASSWORD = 'pefrxznvemusuxnz'  # <-- your App Password
